	...
	public:
    	...
    	virtual void OnImageGrabbed( CInstantCamera& camera, const CGrabResultPtr& ptr_grab_result)
    	{
			...
			if(!motion_act || capture_flag)
			{
				...
				sstream_imgJ << path <<"/camera_" << camera_number << "_img_"<< frame_count << ".jpg";
...
///////////////////////////////////////////////////////////////////////////////////
		             ...
		             {
///////////////////////////////////////////////////////////////////////////////////
				cameras[i].StartGrabbing(strategy,GrabLoop_ProvidedByInstantCamera); 
///////////////////////////////////////////////////////////////////////////////////                                
                             }
			}
			else 
...
void cameras_grab(std::string path, int obs_frames, int rec_frames, bool motion_act, bool direct_save, bool trigger, bool strobe, int liveStream[], int enCam[], int streamCam)
{	
	try
	{ 
		time_t raw_time;
...
//////////////////////////////////////////////////////////////////////////////////
			...
			//WaitObject::Sleep(rec_frames/(fps*1000.0)+2000);
			while(!grabbing_done)
			{
				bool done = true;
				for (int i=0; i<num_devices; i++)
	...
	try
	{
		...
		for (int j=0 ; j < captureMetadata["Number of Cameras"].asInt(); j++)
		{
			...
			for (int i =0; i < captureMetadata["Number of Frames"][to_string(j)].asInt(); i++)
			{
				...
				sstream_imgJ << path <<"/camera_" << j << "_img_"<< captureMetadata["Frame Counts"][to_string(j)][to_string(i)] << ".jpg";
