...
void   cameras_grab(std::string path, int obs_frames, int rec_frames, bool motion_act, bool directSave, bool trigger,bool strobe, int liveStream[], int enCams[], int streamCam); 
